...
export const formatCurrency = (amount, currency = 'ARS') => {
  ...
  // Limpia el código de moneda de cualquier comilla simple.
  const cleanedCurrency = String(currency).replace(/'/g, '');
  ...
  try {
    ...
    // Si el código de moneda sigue siendo inválido, usa un formato por defecto sin símbolo.
    console.error(`Error al formatear moneda con el código '${cleanedCurrency}':`, e);
