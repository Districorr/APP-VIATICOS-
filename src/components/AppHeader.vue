        ...
        <div v-if="isLoggedIn" class="relative">
          ...
          <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
            <div v-if="isNewActionMenuOpen" @click.away="closeAllMenus" class="dropdown-menu text-gray-800 w-56">
              ...
              <RouterLink :to="{ name: 'CargaBultos' }" @click="handleNavLinkClick" class="dropdown-item font-bold text-indigo-700 hover:bg-indigo-50">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-indigo-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
